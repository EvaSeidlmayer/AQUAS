...
def main():
    urls_df = pd.read_csv('/home/ruth/ProgrammingProjects/AQUS/AQUAS/data/data-set-topic-wise_2024/urls/disinfo_infowars_url.csv', sep=',', header=None)
    ...
    for index, row in urls_df.iterrows():
        ...
        infos_df.to_csv('/home/ruth/ProgrammingProjects/AQUS/AQUAS/data/data-set-topic-wise_2024/content/raw_content/disinfo_infowars_2024-06-11.csv', index=False)
    print('done')
