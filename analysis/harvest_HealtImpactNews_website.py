...
def main():
    urls_df = pd.read_csv('/home/ruth/ProgrammingProjects/AQUS/AQUAS/data/disinfo_healthimpactnews_urls.csv' , sep=',')
    ...
    for index, row in urls_df.iterrows():
        ...
        infos_df.to_csv('data/disinfo_healthimpactnews_2023-10-03.csv', index=False)
    print(i)
    print('done')
