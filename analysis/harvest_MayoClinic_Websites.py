...
def get_article_title(url):
    article_title = url.split('https://www.mayoclinic.org/drugs-supplements/drugs-supplements-')[1]
    article_title = article_title.split('/art-')[0]
    return article_title


def main():
    urls_df = pd.read_csv('/AQUS/AQUAS/data/popscience/popscience_MayoClinic_Healthibrary-Website_urls.csv', skiprows=[3], sep=',')
    ...
    infos_df.to_csv('data/popscience_mayoclinic_text_2023-09-20.csv', index=False)
    print('done')
