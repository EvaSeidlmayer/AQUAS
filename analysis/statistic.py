...
df = pd.read_csv('/home/ruth/ProgrammingProjects/AQUS/AQUAS/data/2023-10_final_dataset_cleaned.csv')
#print(df.head())
scientific_df = df.loc[df['category_id'] == 'scientific']
science_text = scientific_df['text']
science_value = 0
i = 0
for i, text in science_text.items():
    value = textstat.flesch_reading_ease(text)
    science_value += value
    i += 1
print('Flesch reading score for scientific texts:', science_value/i)
