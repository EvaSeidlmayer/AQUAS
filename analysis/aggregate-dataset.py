...
def compile_scientific():
    scientific_df = pd.read_csv('/AQUS/AQUAS/data/alternative/science/scientific_PMC-PDF_basic-data_2023-09-21.csv', sep=',', usecols=cols)
...
def compile_pop():
    # popular scientific
    popscience_df_1 = pd.read_csv('/AQUS/AQUAS/data/popscience/popscience_wikipedia-text_2023-10-07.csv', sep=',', usecols=cols)
    popscience_df_2 = pd.read_csv('/AQUS/AQUAS/data/popscience/popscience_medlineplus_text_2023-10-07.csv', sep=',', usecols=cols)
    # mayoclinic!
...
def compile_disinfo():
    breitbart1_df = pd.read_csv('/AQUS/AQUAS/data/disinfo/disinfo_breitbart-abortion_text_2023-09-22.csv', sep=',', usecols=cols)
    breitbart2_df = pd.read_csv('/AQUS/AQUAS/data/disinfo/disinfo_breitbart-transgender_text_2023-09-21.csv', sep=',', usecols=cols)
    mercola1 = pd.read_csv('/AQUS/AQUAS/data/disinfo/disinfo_Mercola_text_2023-09-22.csv', sep=',', usecols=cols)
    mercola2 = pd.read_csv('/AQUS/AQUAS/data/disinfo/disinfo_Mercola_text_2023-09-25.csv', sep=',', usecols=cols)
    mercola3 = pd.read_csv('/AQUS/AQUAS/data/disinfo/disinfo_Mercola_text_2023-10-05.csv', sep=',', usecols=cols)
    healthnews_df = pd.read_csv('/AQUS/AQUAS/data/disinfo/disinfo_healthnews_2023-09-29.csv', sep=',', usecols=cols)
    health_impact_news_df = pd.read_csv('/AQUS/AQUAS/data/disinfo/disinfo_healthimpactnews_2023-10-03.csv', sep=',', usecols=cols)
...
def compile_alternative():
    alt1_df = pd.read_csv('/AQUS/AQUAS/data/alternative/alternative_homeopathicjournal_PDFs.csv', sep=',', usecols=cols)
    alt2_df = pd.read_csv('/AQUS/AQUAS/data/alternative/alternative_Indian-research-Homeopathy_PDF-2023-08-25.csv', sep=',', usecols=cols)
    alt3_df = pd.read_csv('/AQUS/AQUAS/data/alternative/alternative_PAAM-goetheaneum-PDF-2023-10-07.csv', sep=',', usecols=cols)
